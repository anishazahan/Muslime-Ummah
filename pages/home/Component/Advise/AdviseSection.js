          ...
          <div className="left flex flex-col w-full space-y-8 xl:mt-16 2xl:space-x-3">
            ...
            <div className="">
              <button className=" ">
                ...
                >
                  <span className="absolute inset-0 w-full h-full transition-all duration-300 ease-out transform translate-x-0 -skew-x-12 bg-primary group-hover:bg-primary group-hover:skew-x-12"></span>
                  <span className="absolute inset-0 w-full h-full transition-all duration-300 ease-out transform skew-x-12 bg-secondary group-hover:bg-primary group-hover:-skew-x-12"></span>
                  ...
                  <span className="absolute bottom-0 right-0 hidden w-10 h-20 transition-all duration-100 ease-out transform translate-x-10 translate-y-8 bg-secondary -rotate-12"></span>
