...
const Donation = () => {
  ...
  const percentage = parseInt(
    100 - +Math.abs(100 - (raised / goal) * 100).toFixed(10)
  );
  return (
      ...
      <section className="max-width mx-auto">
        <div className="flex flex-col lg:flex-row justify-between items-stretch">
            ...
            >
              <SwiperSlide>
                <img
                  ...
                  src={"https://i.ibb.co/FHxvRPj/donation1.jpg"}
                  alt=""
                />
              </SwiperSlide>
              <SwiperSlide>
                <img
                  className="w-full object-cover"
                  src={"https://i.ibb.co/jWCX8z7/donatio2.jpg"}
                  alt=""
                />
              </SwiperSlide>
              <SwiperSlide>
                <img
                  className="w-full object-cover"
                  src={"https://i.ibb.co/vh7PmWt/donation3.jpg"}
                  alt=""
                />
              </SwiperSlide>
          ...
          <div className="right space-y-4 w-full lg:w-6/12 lg:pl-3 pl-10 md:pl-16 pr-3 mx-auto md:mx-0">
            <h2 className="text-xl font-semibold text-primary mt-5 lg:mt-0">
            ...
            <div>
              ...
              <select
                onChange={(e) => handleSelectFund(e)}
                id="donate"
                class="w-10/12 bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block  p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
              >
                {funds.map((fund) => {
                  return (
                    <>
                      <option value={fund.donationName}>
                        {fund.donationName}
                      </option>
                    </>
                  );
            ...
            <div className="w-6/12 pt-">
              ...
              <div className="flex justify-between w-full mb-5">
                ...
                <h2 className="inline-block text-end">
                  Goal:{" "}
                  <span className="font-semibold text-primary text-xl">
                    ${currentFund?.goal}
                  </span>{" "}
            ...
            <h2 className="text-[22px] text-gray-600 font-medium tracking-wide">
              Billing Information
            </h2>

            <div>
              <h2 className="text-[17px] text-gray-900 font-medium tracking-wide lg:mt-4">
              ...
              <div className="flex mb-5 space-x-6">
                <div className="">
                  <input
                    ...
                    value="HTML"
                  />
                  <label className="text-slate-500 font-semibold" for="html">
                    Paypal
                  </label>
                </div>
            ...
            <form className="w-full">
              <div>
                ...
                <div className="input flex  space-x-2">
                  <input
                    className="border w-1/6 lg:w-1/12 p-2 m-1 text-gray-500 placeholder-black cursor-pointer"
                    type="text"
                    placeholder="$"
                    value={200}
                    readOnly
                  ...
                  />
                  <input
                    className="border p-2 m-1 text-gray-500 placeholder-black "
                    type="number"
              ...
              <div className="input-field flex flex-col w-full">
                <div className="flex  lg:w-full">
                  <input
                    className="border placeholder-slate-700 w-5/12 p-2 m-1 outline-primary"
                    type="text"
