    ...
    <div className='bg-slate-50 mb-10'>
      <div className="xl:container mx-auto">
        <div className="flex flex-col lg:flex-row text-center lg:text-left px-4 md:px-5 lg:px-20 mx-auto">
          <motion.div
            initial={{ x: 600 }} whileInView={{ x: 0 }} transition={{ type: "spring", duration: 0.9, bounce: 0.3 }}
            className="left w-full space-y-7 my-16 ">
          ...
          <motion.div
            initial={{ x: -600 }} whileInView={{ x: 0 }} transition={{ type: "spring", duration: 0.9, bounce: 0.3 }}
            className="right-img sm:w-full mx-2 lg:mx-0 lg:w-3/4 flex flex-col space-y-5 items-center justify-center h-full py-4 lg:py-0">
            <div >
