      ...
      <div className="flex justify-between h-[450px]">
              ...
              <div className="homeBlog flex justify-between items-center shadow-[0px_0px_20px_0px_#d6d6d6] rounded-md">
                ...
                <div className="text-[#555555] mr-2.5">
                  ...
                  <div className="flex text-xs space-x-5 py-3.5">
                    <p className="flex">
                      <FaRegCalendarAlt className="mr-2 text-primary"></FaRegCalendarAlt>{" "}
                      {blog.date}
                    </p>
                    <p className="flex">
                      <AiOutlineUser className="mr-2 text-primary text-sm"></AiOutlineUser>{" "}
                      {blog.writer}
                    </p>
                  </div>
                  <p className="text-sm">{blog.blogText}</p>
                  <button className="mt-4 hover:text-green-600 duration-300">
                    View Details
                  </button>
                </div>
              </div>
        ...
        <div className="w-[40%] flex flex-col justify-between">
          {events.map((event) => {
            ...
            return (
              <div
                className={`homeEvent flex py-5 px-7  shadow-[0px_0px_20px_0px_#d6d6d6]`}
              >
                ...
                <div className="text-[#555555]">
                  ...
                  <div className="flex text-xs space-x-5 py-3">
                    <p className="flex">
                      <GoLocation className="mr-2 text-primary"></GoLocation>{" "}
                      {event.location}
                    </p>
                    <p className="flex">
                      <IoMdTime className="mr-2 text-primary text-sm"></IoMdTime>{" "}
                      {event.time}
                    </p>
                  </div>
