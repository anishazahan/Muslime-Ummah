                ...
                <div className="mx-6 py-10 text-center md:text-left">
                    <div className="grid grid-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
                        ...
                        ">
                            ...
                            <p>
                                Reliance Trends is a leading omnichannel lifestyle retail chain with over 800 retail stores across India. Reliance Trends offers stylish, high-quality products across Womenswear Menswear,
                            </p>
                        </div>
                        <div className="">
                        ...
                        <div className="">
                            ...
                            <p className="sm:mb-4 mb-2">
                                <Link href="manageItems" className="text-gray-600">Manage items</Link>
                            </p>
                            <p className="sm:mb-4 mb-2">
                                <Link href="addItems" className="text-gray-600">Add items</Link>
                            </p>
                            <p className="sm:mb-4 mb-2">
                                <Link href="myItems" className="text-gray-600">My items</Link>
                            </p>
                            <p>
